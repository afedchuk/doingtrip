...
class GoogleTranslater {
	...
	public function translateText($text, $fromLanguage = "en", $toLanguage = "ru", $translit = false) {
		...
		if (empty($this->_errors)) {
			...
			foreach ($offers as $offer) {
				$result[] = $this->translate($offer, $fromLanguage, $toLanguage);
				sleep(1);
			}
	...
	private function translate($text, $fromLanguage = "en", $toLanguage = "ru", $translit = false) {
		$response = $this->_curlToGoogle("https://translate.google.com/#en/uk/hi");
