...
class ImageSettings extends CFormModel {
	...
	public function attributeLabels(){
		return array(
			'maxImageWidth' => ImagesModule::t('maxImageWidth'),
			'maxImageHeight' => ImagesModule::t('maxImageHeight'),
			'useWatermark' => ImagesModule::t('useWatermark'),
			'watermarkType' =>  ImagesModule::t('watermarkType'),
			'watermarkFile' =>  ImagesModule::t('watermarkFile'),
			'watermarkContent' =>  ImagesModule::t('watermarkContent'),
			'watermarkTextColor' =>  ImagesModule::t('watermarkTextColor'),
			'watermarkTextOpacity' =>  ImagesModule::t('watermarkTextOpacity'),
			'watermarkPosition' =>  ImagesModule::t('watermarkPosition'),
			'watermarkTextSize' =>  ImagesModule::t('watermarkTextSize'),
		);
	}
