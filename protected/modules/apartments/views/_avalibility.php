<div id="update-block">
    <div id="check-avalibility" class="well info booking-bar">
        <?php $form = $this->beginWidget('CActiveForm', array(
            ...
            <div class="check-booking"><?php echo ApartmentsModule::t('When are you staying?'); ?> <i class="fa fa-calendar"></i></div>
            <?php  $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                 'model'=>$avalibility,
                 'attribute'=>'check_in',
                 'themeUrl' => Yii::app()->baseUrl . '/css',
                 'language' => Yii::app()->language,
                 'htmlOptions' => array('class' => 'span1', 'placeholder' => BookingModule::t('Check-in date')),
                 'options'=>array(
                     'dateFormat'=>'yy-mm-dd',
                     'minDate'=>'new Date()',
                 ),
             ...
             <?php  $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                 ...
                 'themeUrl' => Yii::app()->baseUrl . '/css',
                 'language' => Yii::app()->language,
                 'htmlOptions' => array('class' => 'span1', 'placeholder' => BookingModule::t('Check-out date')),
                 'options'=>array(
                     'dateFormat'=>'yy-mm-dd',
                     'minDate'=>'new Date()',
                 ),
