...
class CustomGMap {
	...
	public static function addMarker($model, $inMarker, $draggable = 'false'){
		...
		if($model->lat && $model->lng) {
			...
			self::$jsCode .= '
				...
				google.maps.event.addListener(markersGMap['.$model->id.'], "mouseover", function() {
				    ...
				    mapGMap.panTo(latLng'.$model->id.');
				    mapGMap.setZoom(zoom);
				});
			';
	...
	public static function actionGmap($id, $model, $inMarker, $options = array()){
