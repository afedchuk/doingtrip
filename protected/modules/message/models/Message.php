...
class Message extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'receiver_id' => MessageModule::t('Receiver'),
			'subject' => MessageModule::t('Subject letter'),
			'body' => MessageModule::t('Body letter'),
			'is_read' => MessageModule::t('Is Read'),
			'deleted_by' => MessageModule::t('Deleted By'),
			'created_at' => MessageModule::t('Created At'),
		);
	}
